...
% Y_start = [0;1.0139;1.5707;-1e-10;0;0;0;0.76911;0;0.7535]';
% Y_start = [0;1.0139;1.5971;-1e-10;0;0;0;0.78859;0;0.77409]';
Y_start = [0;1.0139;1.5971;-1e-10;0;0;0;0.85534;0;0.8767]';     % FR1.mat
Y_start = [0;1.0139;1.5971;-1e-10;0;0;0;0.914;0;0.90929]';     % FR2.mat, simulation = 1.5792, pval = -1.8,  [0.85, 0.95]
Y_start = [0;1.0139;1.5971;-1e-10;0;0;0;0.92947;0;0.92038]';     % FR3.mat, simulation = 1.594, pval = -1.8,  [0.8, 1]
% Y_start = [0;1.0139;1.5971;-1e-3;0;0;0;0.92019;0;0.90831]';     % FR4.mat, simulation = 1.585, pval = -1.8,  [0.75, 1]
% Y_start = [0;1.0139;1.5971;-1e-3;0;0;0;0.90289;0;0.8867]';     % FR5.mat, simulation = 1.564, pval = -1.8,  [0.5, 1]
% Y_start = [0;1.0139;1.5127;-1e-3;0;0;0;0.85818;0;0.83687]';     % FR6.mat, simulation = 1.573, pval = -1.8,  [0.5, 1] dirac delta on x2
% 
% Y_start = [0;1.0139;1.5127;-1e-3;0;0;0;0.8;0;0.801]';     % test 1.723
...
% Y_start = [ 0, 0, 1.2, 0, 0.1, 0, 0.3, 0, 0.6, 0 ];
...
%     D_FF = @(tt,xx) [ xx(2); FF_Dyn_poly(xx(2:end)) ];
    ...
    D_FF = @(tt,xx) [ xx(2); FF_Dyn(xx(2:end)); -xx(3) ];
