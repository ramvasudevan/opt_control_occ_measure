...
% running cost = ((v*t - 1) - x)^2, where v = 0.2, T = 3
% terminal cost = 0
% 
% IC shifted to -0.5
...
h{1} = (0.15*T*t - 0.5 - y(5))^2 * T;         % h = (0.3 * t/T - 1 - x)^2
H{1} = 0;
...
h{2} = (0.15*T*t - 0.5 - y(1))^2 * T;         % h = (0.3 * t/T - 1 - x)^2
H{2} = 0;
...
h{3} = (0.15*T*t - 0.5 - y(1))^2 * T;         % h = (0.3 * t/T - 1 - x)^2
H{3} = 0;
