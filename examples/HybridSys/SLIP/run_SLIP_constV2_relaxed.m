...
params.umax     = 0.18;          % upper bound of input
...
params.domain{1} =...
        [ 0.05, 0.2;         % l         - leg length
         -0.3, 0.3;         % l_dot     - time derivative of l
           -1, 1;           % theta     - leg angle
           -3, 1;           % theta_dot - time derivative of theta
...
params.domain{2} = ...
         [ -1, 1;           % x         - horizontal displacement
            0, 1;         % x_dot     - time derivative of x
         0.15, 1;         % y         - vertical displacement
...
h{1} = (1.75*t - 1 - y(5))^2 * T;       % h = (1.05 * t/T - 1 - x)^2
H{1} = 0;
...
h{2} = (1.75*t - 1 - y(1))^2 * T;       % h = (1.05 * t/T - 1 - x)^2
H{2} = 0;
...
h{3} = (1.75*t - 1 - y(1))^2 * T;       % h = (1.05 * t/T - 1 - x)^2
H{3} = 0;
