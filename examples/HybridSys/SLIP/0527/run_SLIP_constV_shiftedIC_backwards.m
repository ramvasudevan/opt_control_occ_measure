...
params.domain{2} = ...
         [ -1, 1;           % x         - horizontal displacement
           -0.5, 0.5;         % x_dot     - time derivative of x
...
h{1} = (v*T*t - 0.5 - y(5))^2 * T;         % h = (0.3 * t/T - 1 - x)^2
H{1} = 0;
...
h{2} = (v*T*t - 0.5 - y(1))^2 * T;         % h = (0.3 * t/T - 1 - x)^2
H{2} = 0;
...
h{3} = (v*T*t - 0.5 - y(1))^2 * T;         % h = (0.3 * t/T - 1 - x)^2
H{3} = 0;
