% SLIP model, 1 mode, only stance phase
% Flight phase dynamics is solved by hand, and incorporated into the reset map
...
for i = 1 : nmodes
    scale_x{i} = 2 ./ (domain_size{i}(:,2) - domain_size{i}(:,1));
